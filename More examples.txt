# In this file, we took 199 geometric forms from the Chapter 8 of author's PhD thesis: 
#https://queensu.scholaris.ca//server/api/core/bitstreams/b08499c4-5a74-4bb4-ae2b-c2f9d12b4d3a/content
#Then we apply our main algorithm to check our code for these forms.
# List of 199 ternary quadratic forms [a, b, c, r, s, t] to test Algorithm 23.
# These forms are taken from the tables in the paper.
...
def run_tests():
    ...
    print(f"Running {len(forms_to_check)} Specific Test Cases from Paper...")
